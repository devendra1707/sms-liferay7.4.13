...
import com.armantec.sms.branch.service.persistence.impl.constants.smsPersistenceConstants;
...
public class BranchPersistenceImpl
	 ...
	 */
	@Override
	public List<Branch> findByGroupId(long groupId, boolean deleted) {
	 ...
	 */
	@Override
	public List<Branch> findByGroupId(
	...
	public Branch findByGroupId_First(
		...
		Branch branch = fetchByGroupId_First(
	...
	public Branch fetchByGroupId_First(
		...
		List<Branch> list = findByGroupId(
	...
	public Branch findByGroupId_Last(
		...
		Branch branch = fetchByGroupId_Last(
			groupId, deleted, orderByComparator);
	...
	public Branch[] findByGroupId_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(
				session, branch, groupId, deleted, orderByComparator, true);

			array[1] = branch;

			array[2] = getByGroupId_PrevAndNext(
				session, branch, groupId, deleted, orderByComparator, false);
	...
	protected Branch getByGroupId_PrevAndNext(
		Session session, Branch branch, long groupId, boolean deleted,
		OrderByComparator<Branch> orderByComparator, boolean previous) {
	...
	@Reference
	private BranchModelArgumentsResolver _branchModelArgumentsResolver;
